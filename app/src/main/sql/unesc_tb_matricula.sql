...
CREATE TABLE `tb_matricula` (
  ...
  `codigo_aluno` int DEFAULT NULL,
  `data_matricula` date NOT NULL,
  `dia_vencimento` int NOT NULL,
  `data_encerramento` date DEFAULT NULL,
  PRIMARY KEY (`codigo_matricula`),
  KEY `matricula_fk_idx` (`codigo_aluno`),
  CONSTRAINT `matricula_fk` FOREIGN KEY (`codigo_aluno`) REFERENCES `tb_aluno` (`codigo_aluno`)
...
-- Dump completed on 2020-04-29 14:56:38
